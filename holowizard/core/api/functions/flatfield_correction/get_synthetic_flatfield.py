import pickle
from holowizard.core.preprocessing.correct_flatfield import get_synthetic_flatfield as get_synthetic_flatfield_internal
...
def get_synthetic_flatfield(flatfield_correction_params: FlatfieldCorrectionParams):
    ...
    return get_synthetic_flatfield_internal(flatfield_correction_params.image, components_model)
