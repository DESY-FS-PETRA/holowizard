...
focus_series_paths = FocusSeriesPaths(
    root_dir="/gpfs/petra3/scratch/" + os.environ.get("USER") + "/focus_series_multidim/spider_hair"
)

project_paths = ProjectPaths(
    output_dir="/gpfs/petra3/scratch/" + os.environ.get("USER") + "/focus_series_multidim/spider_hair/projections",
